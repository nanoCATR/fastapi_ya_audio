...
POSTGRES_PORT = os.environ.get("POSTGRES_PORT") #todo POSTGRES_PORT_DOCKER for local, POSTGRES_PORT for docker
POSTGRES_HOST = "db" #todo localhost for local, db for docker
